...
- Currently, coffee-manager-2nd_2.2_amd64.deb is a version supports
...
- [Debian Installer](/installer/debian12/coffee-manager-2nd_2.2_amd64.deb)
...
- Installed Components( pkg v2.2 )
  + elpusk-hid-d : v2.2 : Daemon program.
  ...
  + lpu230_update : v2.1 : lpu230 firmware update utility.
 
- Installation Method
  + If you don't use the google-chrome brower, it must be installed before installating coffee-manager-2nd_2.2_amd64.deb.
  + Before installation, install libnss3-tools.(`sudo apt install libnss3-tools`)
  + sudo dpkg -i coffee-manager-2nd_2.2_amd64.deb
...
- Update Method
  ...
  + install new version : `sudo dpkg -i coffee-manager-2nd_2.2_amd64.deb`
