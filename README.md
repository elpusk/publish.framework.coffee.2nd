...
- Currently, coffee-manager-2nd_2.4_amd64.deb is a version supports
...
- [Debian Installer](/installer/debian12/coffee-manager-2nd_2.4_amd64.deb)
...
- Installed Components( pkg v2.4 )
  + elpusk-hid-d : v2.4 : Daemon program.
...
- Installation Method
  + If you don't use the google-chrome brower, it must be installed before installating coffee-manager-2nd_2.4_amd64.deb.
  + Before installation, install libnss3-tools.(`sudo apt install libnss3-tools`)
  + sudo dpkg -i coffee-manager-2nd_2.4_amd64.deb
...
- Update Method
  ...
  + install new version : `sudo dpkg -i coffee-manager-2nd_2.4_amd64.deb`
