...
- Currently, coffee-manager-2nd v2.12 is a version supports
...
- [Debian Installer](/installer/debian12/coffee-manager-2nd_2.12_amd64.deb)
...
- Installed Components( installer v2.12 )
  + coffee-service.exe : v2.2 : service program for Windows
  + elpusk-hid-d(elpusk-hid-d.exe) : v2.11 : Daemon program.
  ...
  + lpu23x-ibutton-mcp(lpu23x-ibutton-mcp.exe) : v1.0 : lpu237 magnetic card reading MCP server.
  + lpu23x-msr-mcp(lpu23x-msr-mcp.exe) : v1.0 : lpu237 i-button reading MCP server. 
 
- Installation Method  
  __*Warning: All web browsers must be closed before installation.*__
  - Debian12
    + If you don't use the google-chrome brower, it must be installed before installating coffee-manager-2nd_2.12_amd64.deb.
    + Before installation, install libnss3-tools.(`sudo apt install libnss3-tools`)
    + sudo dpkg -i coffee-manager-2nd_2.12_amd64.deb
  - Windows11
...
- Update Method
  ...
  + install new version : `sudo dpkg -i coffee-manager-2nd_2.12_amd64.deb`
